...
const SignIn = () => {
  ...
  // Show error toast if OAuth redirects back with an error
  React.useEffect(() => {
    const params = new URLSearchParams(location.search);
    const errorMsg = params.get('error');
    if (errorMsg) {
      toast.error(`OAuth Error: ${errorMsg.replace(/_/g, ' ')}`);
    }
  }, [location]);
        ...
        <div className="w-full max-w-[400px] flex flex-col items-center">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="w-full flex flex-col gap-3" noValidate>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full p-4 border rounded-lg text-gray-900 focus:outline-none transition ${errors.email ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-green-600'
                  }`}
              />
            ...
            <div className="relative">
              <input
                ...
                className={`w-full p-4 border rounded-lg text-gray-900 focus:outline-none transition ${errors.password ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-green-600'
                  }`}
              />
          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <a 
              ...
              className="w-full border border-gray-300 rounded-lg p-3 flex items-center justify-center gap-3 hover:bg-gray-50 transition cursor-pointer"
            >
